...
export class InitialMigrationTable1710513847900 implements MigrationInterface {
    name = 'InitialMigrationTable1710513847900'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favorites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "artists" uuid array, "albums" uuid array, "tracks" uuid array, CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`);
